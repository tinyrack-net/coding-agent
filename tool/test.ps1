...
$packages = [ordered]@{
    ...
    app = @{
        ...
        Core = @(
            ...
            'test/agent_screen_sync_state_test.dart'
            'test/timeline_provider_test.dart'
            'test/fluent_toast_test.dart'
            'test/checkout_link_selection_test.dart'
            'test/core/desktop/agent_hot_route_startup_test.dart'
            'test/core/desktop/windows_agent_deep_link_source_test.dart'
            'test/project_conversation_vertical_e2e_test.dart'
